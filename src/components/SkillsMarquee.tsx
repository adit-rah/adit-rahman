...
const skills: Skill[] = [
  ...
  { name: "Java", icon: <SiOpenjdk />, description: "JVM-backed application development" },
  ...
  { name: "C", icon: <SiC />, description: "Low-level systems programming" },
  { name: "React", icon: <SiReact />, description: "Component-based UI library" },
  { name: "Node.js", icon: <SiNodedotjs />, description: "JavaScript runtime for servers and tooling" },
  { name: "GraphQL", icon: <SiGraphql />, description: "API query language and schema design" },
  ...
  { name: "OpenTelemetry", icon: <SiOpentelemetry />, description: "Distributed tracing and metrics" },
  ...
  { name: "Buildkite", icon: <SiBuildkite />, description: "CI/CD pipelines at scale" },
  { name: "Airflow", icon: <SiApacheairflow />, description: "Workflow orchestration" },
  ...
  { name: "MySQL", icon: <SiMysql />, description: "Relational database (Vitess lineage)" },
  { name: "Redis", icon: <SiRedis />, description: "In-memory datastore and queues" },
  { name: "SQLite", icon: <SiSqlite />, description: "Embedded relational database" },
